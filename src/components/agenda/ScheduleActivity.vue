  ...
  <div class="row q-col-gutter-sm">
    <div class="col-12">
      <TextInput
        ...
        :required="true"
        v-model="scheduleObj.description"
      />
    </div>
    <div class="col-6">
  ...
  data() {
    return {
      scheduleObj: {
        ...
        description: this.schedule.id ? this.schedule.Schedule.description : '',
  ...
  methods: {
    async saveSchedule() {
      ...
      try {
        ...
        this.$q.notify({
          message: `Seu compromisso foi ${
            this.scheduleObj.id ? 'reagendado' : 'criado'
          } com sucesso`,
          color: 'positive',
        });
        setTimeout(() => {
        ...
        this.$q.notify({
          message: `Erro ao ${this.scheduleObj.id ? 'reagendar' : 'criar'} compromisso`,
          color: 'negative',
        });
      }
      this.$q.loading.hide();
